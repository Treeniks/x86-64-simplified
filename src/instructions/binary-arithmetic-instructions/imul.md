...
|                          |                                      |
| `IMUL r16, r/m/imm16`*   | `r16 = r16 * r/m16`                  |
| `IMUL r32, r/m/imm32`*   | `r32 = r32 * r/m32`                  |
| `IMUL r64, r/m64`        | `r64 = r64 * r/m64`                  |
| `IMUL r64, imm32`*       | `r64 = r64 *` sign extended `imm32`  |
|                          |                                      |
...
\* The official Intel Manual does not include the ability to use `IMUL` with immediates in the two-operand form. However, this still seems to work, but it might not be accurately documented here.
